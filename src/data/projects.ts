...
export const projects = [
	...
	},
	{
		...
		stack: "MERN, TypeScript, Redux Toolkit, Tailwind, React Query, Tiptap",
		website: isNotDeployed,
		code: "https://github.com/luka0009/Full-stack-Blog-App",
	},
	{
		id: 903,
		image: fitness,
		...
		stack: "Vue, Supabase, Tailwind Css",
	...
	},
	{
		...
		description: `WARNING: THE APP WILL TAKE ABOUT A MINUTE TO LOAD, SINCE THE BACKEND IS DEPLOYED WITH A FREE PLAN AND DOESN'T WORK FULLY EFFICIENTLY -  
	...
	},
	{
		...
		description:
			"Full stack Airbnb clone created with: Next.js (version 13), Next-auth, Tailwind css, Typescript, Prisma, MongoDb, Zustand, Cloudinary. It has all the feauteres, authentication, hosting, reserving, favoriting functionality and etc. you can also manage your trips, reservations, facorites and your listings.",
		stack:
			"Next.js-13, Next-auth, TS, Tailwind, Prisma, MongoDB, Zustand, CLoudinary",
